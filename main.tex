...
\newpagestyle{ruled}{
	\sethead{\includegraphics[width=3.7cm]{./images/UADE_LARGE}}
			{\parbox[b]{0.43\textwidth}{\raggedright\scriptsize\MakeUppercase{NIDIO: Plataforma de análisis de propiedades y del entorno urbano en CABA para la toma de decisiones de usuarios, utilizando datos geoespaciales}}} % El parámetro 0.43 puede modificarse para tener más espacio en la columan del medio, y que así el título de la tesis entre mejor.
			{
				\raisebox{1.5ex}{%
...
\AddToHook{cmd/chapter/before}{\Needspace{5\baselineskip}}
